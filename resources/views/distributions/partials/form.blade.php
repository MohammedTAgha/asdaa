...
<div class="mb-4">
    ...
    <input type="date" id="arrive_date" name="arrive_date"
        value="{{ old('arrive_date', $distribution->arrive_date ?? '') }}" required
        class="mt-1 block w-full rounded border-gray-300">
</div>
<div class="mb-4">
