    ...
    <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <div class="mb-4 text-center">
            <a href="{{ route('citizens.template') }}"
                class="px-4 py-2 text-white bg-green-500 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">Download
                Template</a>
        </div>
        ...
        <form action="{{ route('citizens.upload') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-center">
                <button type="submit"
                    class="px-10 py-4 text-xl font-semibold text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Upload</button>
            </div>
        </form>
    </div>
